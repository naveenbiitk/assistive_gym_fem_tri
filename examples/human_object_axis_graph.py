...
shoulder_pos,shoulder_orient = env.robot.get_pos_orient(env.robot.base)
generate_line(shoulder_pos, shoulder_orient, lineLen=0.3)


shoulder_pos = [shoulder_pos[0],shoulder_pos[1]+0.9,shoulder_pos[2]]
generate_line(shoulder_pos, shoulder_orient, lineLen=0.5)

wrist_pos,wrist_orient = env.robot.get_pos_orient(env.robot.left_tool_joint)
generate_line(wrist_pos, wrist_orient, lineLen=0.1)
