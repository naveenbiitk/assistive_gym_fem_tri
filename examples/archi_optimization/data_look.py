...
print('X: ',np.max(sphere_points[:,0]),np.min(sphere_points[:,0]) )
print('Y: ',np.max(sphere_points[:,1]),np.min(sphere_points[:,1]) )
print('Z: ',np.max(sphere_points[:,2]),np.min(sphere_points[:,2]) )
