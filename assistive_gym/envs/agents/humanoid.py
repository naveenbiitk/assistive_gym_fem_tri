...
motion_right_arm_joints = [ 2, 3, 4, 5, 6, 7]
...
human_walk = [ 27, 26, 25, 28, 29, 30, 31, 35, 36, 37, 38, 3, 0, 6, 13, 10, 16]
...
# [
# self.j_waist_z, self.j_waist_y, self.j_waist_x,
# self.j_right_hip_x, self.j_right_hip_y, self.j_right_hip_z, self.j_right_knee,
# self.j_left_hip_x, self.j_left_hip_y, self.j_left_hip_z, self.j_left_knee,
# self.j_right_shoulder_x, self.j_right_pecs_x, self.j_right_elbow 
# self.j_left_shoulder_x,self.j_left_pecs_x, self.j_left_elbow
# ]
