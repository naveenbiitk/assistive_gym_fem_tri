...
def optimizing_function(points, env_human, env_id, env):
    ...
    run_simulation(env_human, env_id, target_pose_angles , 48, env, target_position)
    env_human.set_joint_angles(env_human.right_arm_joints, target_pose_angles)
    ...
    print('func moment',f_moment,'func moment',f_angle,'func moment',f_manipulability,'func moment',f_neck, 'func_eye',f_eye_distance)
