...
human_actions = { ord('1'): np.array([ -0.01, 0, 0, 0, 0, 0]), ord('2'): np.array([ 0.01, 0, 0, 0, 0, 0]),
                  ord('3'): np.array([ 0, -0.01, 0, 0, 0, 0]), ord('4'): np.array([ 0, 0.01, 0, 0, 0, 0]), 
                  ord('5'): np.array([ 0, 0, -0.01, 0, 0, 0]), ord('6'): np.array([ 0, 0, 0.01, 0, 0, 0]), 
                  ord('7'): np.array([ 0, 0, 0, -0.01, 0, 0]), ord('8'): np.array([ 0, 0, 0, 0.01, 0, 0]),
                  ord('9'): np.array([ 0, 0, 0, 0, -0.01, 0]), ord('0'): np.array([ 0, 0, 0, 0, 0.01, 0]),
                  ord('u'): np.array([ 0, 0, 0, 0, 0, -0.01]), ord('i'): np.array([ 0, 0, 0, 0, 0, 0.01])
                  }
